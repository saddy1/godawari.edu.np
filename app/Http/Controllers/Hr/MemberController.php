...
{
    public function __construct(private LibraryClearanceService $libraryClearance)
    {
    }
    ...
    {
        $this->libraryClearance->attachTo($members, $usersOnly);
    }

    private function libraryClearanceSummary(?int $studentId, ?int $userId): array
    {
        return $this->libraryClearance->summaryFor($studentId, $userId);
    }
