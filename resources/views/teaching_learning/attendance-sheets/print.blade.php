...
<head>
    ...
    <style>
        @page{size:A4 portrait;margin:8mm}*{box-sizing:border-box}html,body{margin:0;background:#edf1ef;color:#17251d;font-family:Arial,"Noto Sans Devanagari",sans-serif}
        ...
        .head{display:grid;grid-template-columns:16mm 1fr 20mm;align-items:center;border-bottom:.55mm solid #154f32;padding:0 .7mm 1.5mm}.head-copy{display:grid;gap:.45mm}.logo-mark{display:grid;width:14mm;height:14mm;place-items:center;overflow:hidden;border:.25mm solid #aec2b6;border-radius:2mm;background:#f2f7f3;color:#154f32;font-size:8px;font-weight:900}.logo{display:block;width:100%;height:100%;object-fit:contain}.institution{text-align:center;color:#154f32;font-size:16px;line-height:1.05;font-weight:900}.address,.meta{text-align:center;color:#53645b;font-size:6.2px;line-height:1.15;font-weight:700}.title{text-align:center;font-size:9px;line-height:1.1;font-weight:900;letter-spacing:.3px}.page-no{text-align:right;font-size:6px;line-height:1.25;font-weight:800;color:#66756d}
        .scope{display:grid;grid-template-columns:1.2fr 1fr 1fr 1fr;margin-top:1mm;border:.25mm solid #405047;background:#f2f7f3}.scope div{min-width:0;padding:.85mm 1.6mm;border-right:.25mm solid #a6b0aa;font-size:5.5px;line-height:1.1}.scope div:last-child{border:0}.scope b{display:block;margin-top:.35mm;font-size:7px;color:#17251d;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
        table{width:100%;margin-top:1mm;border-collapse:collapse;table-layout:fixed}th,td{border:.22mm solid #273a30;padding:.2mm;text-align:center;vertical-align:middle;font-size:5.4px}th{height:4.4mm;background:#e8f1eb;font-size:5.8px;font-weight:900}.sn{width:6mm}.sn-cell{font-size:6.3px;font-weight:900}.code{width:17mm;padding-left:.8mm;text-align:left;font-size:6.8px;font-weight:900}.student{width:40mm;padding-left:.8mm;text-align:left;font-size:9px;font-weight:900;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.day{width:auto}.student-row{height:4.1mm}.total-label{text-align:right;padding-right:1.5mm;font-size:6.2px;font-weight:900;background:#f4f6f5}.total-cell{height:3.5mm;font-size:5.3px;font-weight:900}
        .foot{display:grid;grid-template-columns:1fr 1fr 1fr;gap:14mm;margin-top:7mm}.sign{border-top:.25mm solid #4d5d54;padding-top:1mm;text-align:center;font-size:6.5px;font-weight:900}.legend{margin-top:1.2mm;padding-left:.5mm;font-size:5px;color:#68776f}.empty{height:150mm;display:grid;place-items:center;text-align:center;font-weight:900;color:#718078}
...
<section class="page">
    ...
    @else
        <table>
            ...
            <tbody>@foreach($pageStudents as $student)<tr class="student-row"><td class="sn-cell">{{$printPage['start_number']+$loop->iteration}}</td><td class="code">{{$student->roll_number?:$student->registration_no}}</td><td class="student">{{$student->full_name}}</td>@foreach($days as $day)<td>{{$day['ad']?($pageAttendance[$student->id.'|'.$day['ad']]??''):''}}</td>@endforeach</tr>@endforeach</tbody>
            <tfoot>
