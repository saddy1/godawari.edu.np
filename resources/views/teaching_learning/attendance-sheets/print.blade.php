...
<head>
    ...
    <style>
        ...
        table{width:100%;margin-top:1mm;border-collapse:collapse;table-layout:fixed}th,td{border:.22mm solid #273a30;padding:.2mm;text-align:center;vertical-align:middle;font-size:5px}th{height:4.4mm;background:#e8f1eb;font-size:5.5px;font-weight:900}.sn{width:6mm}.sn-cell{font-size:6px;font-weight:800}.code{width:17mm;padding-left:.8mm;text-align:left;font-size:6.5px;font-weight:900}.student{width:40mm;padding-left:.8mm;text-align:left;font-size:8.5px;font-weight:900;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.day{width:auto}.student-row{height:var(--page-row-height)}.total-label{text-align:right;padding-right:1.5mm;font-size:5.8px;font-weight:900;background:#f4f6f5}.total-cell{height:3.5mm;font-size:5px;font-weight:900}
...
@php
    ...
    $pageRowHeight=number_format(224 / max(20, $pageStudents->count()), 3, '.', '');
@endphp
<section class="page" style="--page-row-height:{{$pageRowHeight}}mm">
